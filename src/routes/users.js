...
// Login Page
router.get('/login', forwardAuthenticated, (req, res) => res.render('nou-login'));

// Register Page
router.get('/register', forwardAuthenticated, (req, res) => res.render('nou-register'));
...
router.post('/register', (req, res) => {
  ...
  if (errors.length > 0) {
    res.render('nou-register-errors', {
      errors,
      name,
      email,
      password,
        ...
        bcrypt.genSalt(10, (err, salt) => {
          bcrypt.hash(newUser.password, salt, (err, hash) => {
            ...
            newUser
              .save()
              .then(user => {
                enviarMail(newUser.email, newUser._id, newUser.name);
                req.flash(
                  'success_msg',
